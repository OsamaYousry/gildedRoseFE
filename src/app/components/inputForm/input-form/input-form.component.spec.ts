...
describe('InputFormComponent', () => {
    ...
    beforeEach(async () => {
        await TestBed.configureTestingModule({
            ...
            providers: [
                provideMockStore({
                    initialState: { items: { loading: false, entity: [] } },
                }),
            ],
            imports: [
                FormsModule,
    ...
    it('should validate quality not less than 0', () => {
        validateFormFieldError(
            'quality',
            -1,
            'min',
            'Quality cannot be less than zero'
        )
        validateButtonPress(fixture, false, store, {
            name: '',
            quality: 0,
            sellIn: 0,
            id: 0,
    ...
    it('should disable and set value for quality in case of Sulfuras', async () => {
        ...
        let inputElement = fixture.debugElement.query(By.css(`input#quality`))
            .nativeElement
    ...
    it('should reenable value for name and throw error for quality', async () => {
        ...
        fixture.detectChanges()
        await fixture.whenStable()
        let errorMessageElement = fixture.debugElement.query(
            By.css('mat-error')
        ).nativeElement
    ...
    it('should validate name not empty', () => {
        fixture = validateFormFieldError(
            'name',
            null,
            'required',
            'Name is required'
    ...
    it('should reset form after adding item', async () => {
        ...
        fixture.detectChanges()
        await fixture.whenStable()
        let inputElement = fixture.debugElement.query(By.css(`input#name`))
            .nativeElement
        expect(inputElement.value).toBe('')
        inputElement = fixture.debugElement.query(By.css(`input#quality`))
            .nativeElement
        expect(inputElement.value).toBe('')
        inputElement = fixture.debugElement.query(By.css(`input#sellIn`))
            .nativeElement
        expect(inputElement.value).toBe('')
        let errorMessageElement = fixture.debugElement.query(
            By.css('mat-error')
...
function validateFormFieldError(
